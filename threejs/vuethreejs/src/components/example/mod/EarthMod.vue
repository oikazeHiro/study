...
import mesh from '@/models/other/earthMod'
...
scene.add(new THREE.AxesHelper(100)) // 坐标轴辅助器
const directionalLight = new THREE.DirectionalLight(0xffffff, 1)
directionalLight.position.set(100, 100, 100).normalize() // 定向光
